<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\phpstudy_pro\WWW\shangdonglichang/application/sdlcadmin\view\index\index.html";i:1615354125;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="__UPLOADS__/<?php echo $website['logo']; ?>" style="border-radius: 0%;width:100%"/></span>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="footer">
                <div class="pull-right">
                    版权所有 : <?php echo $website['copyright']; ?>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
