<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\phpstudy_pro\WWW\shangdonglichang/application/sdlcadmin\view\login\index.html";i:1611800878;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen  animated fadeInDown">
        <div>
            <div>
                <h1 class="logo-name">uvclinic</h1>
            </div>
            <h3>欢迎登录上海全景中心后台<?php echo session('user.name'); ?></h3>
